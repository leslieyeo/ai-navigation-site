        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              发现最新最好用的AI工具，提升你的工作效率。我们精心筛选和分类各种AI工具，帮助你找到最适合的解决方案。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/categories/writing" className="text-gray-400 hover:text-white transition-colors">
                  AI写作
                </Link>
              </li>
              <li>
                <Link href="/categories/image" className="text-gray-400 hover:text-white transition-colors">
                  AI绘画
                </Link>
              </li>
              <li>
                <Link href="/categories/video" className="text-gray-400 hover:text-white transition-colors">
                  AI视频
                </Link>
              </li>
              <li>
                <Link href="/categories/code" className="text-gray-400 hover:text-white transition-colors">
                  AI代码
                </Link>
              </li>
            </ul>
